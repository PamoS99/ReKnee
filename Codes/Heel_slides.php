...
if (isset($_POST['continbtn'])) {
    $sqlm = mysqli_query($con, "SELECT * FROM currentexercise WHERE user_id='1' and excersie_id='4'");
    ...
    if ($rowm > 0) {
        ...
        $sqls = mysqli_query($con, "update currentexercise set status='0' WHERE user_id='1'");
        $sqls = mysqli_query($con, "insert into currentexercise (status,user_id,excersie_id) VALUES (1, 1, 4)");
    }
    $currentDate = date('Y-m-d');
       $countdayyss= $_SESSION['selectedDay'];
    $sqlmss = mysqli_query($con, "SELECT * FROM repcountset WHERE user_id='1' and excersie_id='4'and daynumber='$countdayyss'");
    $rowmss = mysqli_fetch_array($sqlmss);
    if ($rowmss > 0) {
        
    } else {
        $sqlmssa = mysqli_query($con, "SELECT * FROM repcountset WHERE user_id='1' and excersie_id='4' order by id desc limit 1");
        ...
        if ($rowmssa > 0) {
            ...
            $sqls = mysqli_query($con, "insert into repcountset (setnumber,daynumber,datetime,status,excersie_id,user_id) VALUES (1, '$countdayy','$currentDate',1,4,1)");
        } else {
            $countdayy= $_SESSION['selectedDay'];
            $sqls = mysqli_query($con, "update repcountset set status='0' WHERE user_id='1' and excersie_id='4'");
            $sqls = mysqli_query($con, "insert into repcountset (setnumber,daynumber,datetime,status,excersie_id,user_id) VALUES (1, '$countdayy','$currentDate',1,4,1)");
    ...
    $sqlmssr = mysqli_query($con, "SELECT * FROM repcountset WHERE user_id='1' and excersie_id='4' order by id desc limit 1");
    $rowmssr = mysqli_fetch_array($sqlmssr);
    if ($rowmssr > 0) {
        $idddd=$rowmssr['id'];
        $sqlmssat = mysqli_query($con, "SELECT * FROM repcheckcount WHERE user_id='1' and excersie_id='4' and repcountset_id='$idddd' order by id desc limit 1");
        $rowmssat = mysqli_fetch_array($sqlmssat);
        if ($rowmssat > 0) {
            
        }else{
            $sqls = mysqli_query($con, "update repcheckcount set status='0' WHERE user_id='1' and excersie_id='4'");
            $sqls = mysqli_query($con, "insert into repcheckcount (count,status,excersie_id,user_id,repcountset_id) VALUES (0, 1,4,1,'$idddd')");
        }
    }
    header('location:Heel_slides_dashboard.php');
}
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <div class="col-sm-12 col-lg-6 pb-3"> 
                    ...
                    <div class="bg-light position-relative">
                        <img  class=" d-flex justify-content-center" src="img/HeelSlides.png" alt="" style="width:75%; height: auto ;margin: auto; border: black solid"></img>                       
                    </div>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            Sit on a bed or table with your legs extended in front of you. 
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingTwo">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            <b>Sliding the Heel:</b>
                                        </button>
                                    </h2>
                                    <div id="collapseTwo" class="accordion-collapse collapse"
                                        aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            Slowly slide the heel of the operated leg towards your buttocks by bending the knee.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseThree" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            Hold the bent position for 5-10 seconds, trying to bring your heel as close as comfortable.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseFour" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            Slowly slide your heel back to the starting position, straightening the leg fully.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                    ...
                    <div class="bg-light rounded d-flex align-items-justify p-1 ">
                        <ol>
                            <li>Use a smooth surface or wear socks to make sliding easier.</li>
                            <li> Keep the non-operated leg relaxed throughout the exercise.</li>
                        </ol>
                    ...
                    <div class="bg-light rounded d-flex align-items-right justify-content p-4">                  
                        <iframe class=" d-flex justify-content-center " allowfullscreen=" "accesskey=""src="https://www.youtube.com/embed/EXhwWqPGDeA" style="width:75%; height: 100% ; margin: auto"> 
                        </iframe> 
                    </div>
                    <form method="post">
