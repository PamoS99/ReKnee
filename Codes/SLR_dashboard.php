...
if (isset($_POST['startbtn'])) {
    $sqlm = mysqli_query($con, "SELECT * FROM currentangle WHERE user_id='1' and excersie_id='3' order by id desc limit 1");
    ...
    if ($rowm > 0) {
        ...
        $sqlmssl = mysqli_query($con, "SELECT * FROM repcheckcount WHERE user_id='1' and excersie_id='3' order by id desc limit 1");
        ...
        $sqlmssf = mysqli_query($con, "SELECT * FROM repcountset WHERE user_id='1' and excersie_id='3' order by id desc limit 1");
        ...
        if ($rowmssf > 0) {
            ...
            $sqls = mysqli_query($con, "insert into calibrationangle (angle1,angle2,status,user_id,excersie_id,datetime,repcountset_id) VALUES ($angle1,$angle2,1, 1, 3,'$ccdatetime','$idddddd')");
        }
...
if (isset($_POST['nextbtn'])) {
    ...
    if ($rowmssf > 0) {
        ...
        $sqls = mysqli_query($con, "insert into repcountset (setnumber,daynumber,datetime,status,excersie_id,user_id,starttime) VALUES ('$setnumberr', '$daynumber','$currentDate',1,3,1,'$endDatetime')");
    }
    $sqlmssf = mysqli_query($con, "SELECT * FROM repcountset WHERE user_id='1' and excersie_id='3' order by id desc limit 1");
    $rowmssf = mysqli_fetch_array($sqlmssf);
    if ($rowmssf > 0) {
        $idddd = $rowmssf['id'];
        $sqls = mysqli_query($con, "update repcheckcount set count='0' WHERE user_id='1' and excersie_id='3'");
...
<html lang="en">
    ...
    <head>
        ...
        function updateH1() {
            ...
            xhr.open('GET', 'SLR_update_angle.php', true);
        ...
        function updateH2() {
            ...
            // Configure it: GET-request for the URL /update.php
            xhr.open('GET', 'SLR_update_count.php', true);
                            ...
                            <div class="row g-4 justify-content-between p-2">
                                ...
                                <div class="column w-50 ">
                                    <div class="bg-light rounded h-100 p-4 ">
                                        ...
                                        $sqlmssfm = mysqli_query($con, "SELECT * FROM repcountset WHERE user_id='1' and excersie_id='3' order by id desc limit 1");
