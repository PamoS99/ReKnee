...
$calangle1 = 0;
$calangle2 = 0;
$sqlms = mysqli_query($con, "SELECT * FROM calibrationangle WHERE user_id='1' and excersie_id='2' order by id desc limit 1");
...
if ($angle1 > 15) {
    $sqlmss = mysqli_query($con, "SELECT * FROM repcheck WHERE user_id='1' and excersie_id='2'");
    ...
    if ($rowmss > 0) {
        ...
        $sqls = mysqli_query($con, "insert into repcheck (checkstatus,user_id,excersie_id,status) VALUES (1,1,2,1)");
    }
}
if ($angle1 < 5) {
    $sqlmss = mysqli_query($con, "SELECT * FROM repcheck WHERE user_id='1' and excersie_id='2'");
    ...
    if ($rowmss > 0) {
        ...
        $sqls = mysqli_query($con, "INSERT INTO repcheck('checkstatus', 'status', 'user_id', 'excersie_id') VALUES ('0','1','1','2')");
    }
}
